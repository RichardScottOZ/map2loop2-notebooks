...
graph [
  ...
  edge [
    source 5
    target 6
    graphics [ style "line" arrow "last" width 5 fill "#000fef" ]
  ]
  edge [
    source 1
    target 4
  ...
  edge [
    ...
    LabelGraphics [ text "1" fill "#00ff00" fontSize 14 fontStyle "bold" model "centered" position "center" outline "#000000"]
  ]
  edge [
    source 12
    target 13
